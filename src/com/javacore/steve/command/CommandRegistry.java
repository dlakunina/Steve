...
/**
 * The enum, that holds all allowed commands
 * Implements the singleton paradigm, so there can be only one enum member INSTANCE
 */
public enum CommandRegistry {
    ...
    private static Map<String, ACommand> commands;
